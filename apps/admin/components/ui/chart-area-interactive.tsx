...
import { ChartConfig, ChartContainer, ChartTooltip, ChartTooltipContent } from "@eugenios/ui/components/chart";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@eugenios/ui/components/select";
import { ToggleGroup, ToggleGroupItem } from "@eugenios/ui/components/toggle-group";
...
export function ChartAreaInteractive() {
  ...
  return (
    <Card className="@container/card relative">
      <div className="absolute top-4 right-4 z-10 @[767px]/card:hidden">
      ...
      <div className="absolute top-4 right-4 z-10 hidden @[767px]/card:flex">
        <ToggleGroup
          type="single"
          value={timeRange}
