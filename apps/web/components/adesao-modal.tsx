...
export function AdesaoModal({ isOpen, onClose }: AdesaoModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="w-[95vw] max-w-[700px] max-h-[95vh] p-0 overflow-hidden border-0 rounded-2xl md:rounded-3xl shadow-2xl">
                ...
                {showSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-neutral-600 leading-relaxed text-base md:text-lg max-w-xs md:max-w-sm mx-auto px-4 md:px-0">
                      Recebemos a sua solicitação de adesão. A nossa equipa entrará em contacto consigo nas próximas 24
                      horas.
                    </p>
                  </motion.div>
                ) : error ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="space-y-1 md:space-y-2">
                        ...
                        <Typography as="p" variant="caption" className="text-center text-xs md:text-sm px-2 md:px-0">
